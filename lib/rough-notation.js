...
class RoughAnnotationImpl {
    ...
    svgRect(svg, bounds) {
        ...
        const rect2 = bounds;
        return {
            x: ((this._config.left - 7) - ((((rect1.left - ((_a = this._config.sectionRect) === null || _a === void 0 ? void 0 : _a.x)) / this._config.scala) - (this._config.margin || 360)) - 7)) || ((rect2.x || rect2.left) - (rect1.x || rect1.left)),
            y: ((this._config.top) - ((rect1.top - ((_b = this._config.sectionRect) === null || _b === void 0 ? void 0 : _b.y)) / this._config.scala)) || ((rect2.y || rect2.top) - (rect1.y || rect1.top)),
