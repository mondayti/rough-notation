...
class RoughAnnotationImpl {
    ...
    svgRect(svg, bounds) {
        ...
        const rect2 = bounds;
        return {
            x: ((this._config.left - 7) - ((((rect1.left - ((_a = this._config.sectionRect) === null || _a === void 0 ? void 0 : _a.x)) / this._config.scala) - 360) - 7)) || ((rect2.x || rect2.left) - (rect1.x || rect1.left)),
